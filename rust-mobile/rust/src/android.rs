...
#[no_mangle]
pub extern "system" fn Java_dev_ucokcode_rusty_1android_1lib_RustyKt_helloDirect(
  env: JNIEnv,
  _: JClass,
  input: JString,
) -> jstring {
...
#[no_mangle]
pub extern "system" fn Java_dev_ucokcode_rusty_1android_1lib_RustyKt_hello(
  env: JNIEnv,
  _: JClass,
  input: JString,
) -> jstring {
